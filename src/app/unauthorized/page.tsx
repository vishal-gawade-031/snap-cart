...
export default function Unauthorized() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-linerar-to-br from-indigo-600 via-purple-600 to-pink-500 px-6 py-12">
      <div className="max-w-xl w-full bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:justify-center">
         <Link href="/register" className='inline-block px-5 py-2 rounded-lg border border-indigo-600 text-indigo-700 bg-white hover:bg-indigo-50 transition'>Sign up</Link>
          <Link href="/login" className="inline-block px-5 py-2 rounded-lg border border-indigo-600 text-indigo-700 bg-white hover:bg-indigo-50 transition">Login</Link>
        </div>
